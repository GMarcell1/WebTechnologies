...
export class WatchComponent implements OnInit {
  ...
  delete(watch: Watch) {
    this.service.deleteWatch(watch).subscribe(() => {
      alert("The deletion of the car was successful.");
      this.getWatches();
    }, (err) => {
      alert("An error occurred while deleting the car : " + err.message);
      this.getWatches();
    });
  }
  ...
  increasePrice(watch: Watch) {
    ...
    this.service.updateWatch(watch).subscribe(() => {
      alert("The car price was increased to " + "$" + watch.price);
      this.getWatches();
    }, (err) => {
      alert("An error occurred while increasing the car price : " + err.message);
      this.getWatches();
    });
  }
